...
if IsBuffExist(8326) == 0 then -- 如果身上没有带着灵魂状态的Debuff
    ...
    jumpA(9.31632,-2.35937,-1.09519) --跳过树状
    ...
    for i = 1, 50, 1 do
        ...
        if unusedBag > 14 and headDuration >= 20 then --如果装备不红，背包没满，就出本继续
    ...
    elseif unusedBag <= 14 or headDuration < 20 then --如果装备红了或者背包满了回城修理
